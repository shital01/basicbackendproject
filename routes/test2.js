...
async function calculateTotalAmountwithAdjustedMonthAndYear() {
  try {
    ...
    allTransactions.forEach((transaction) => {
      ...
      const n = calculaterhelper(giveDate,Math.floor(rotationPeriod/30));//return n,d
      var f=1;
      ...
      //const f = rotationPeriod/interestPeriod;
        ...
        console.log(principalAmount,interestRate,interestPeriod,rotationPeriod,n.rotation,n.pendingdays ,totalAmount)  
    });
