...
//Coverage for cover and path not taken good idea
  describe('POST/',()=>{
    ...
    beforeEach(async()=>{
      ...
      token = new User({_id:userid,phoneNumber:"1313131212",name:"name1"}).generateAuthToken();
      await User({name:"notifyuser",phoneNumber:"1313131210",fcmToken:"1"}).save()
...
/*************PUT*********/
  ...
  describe('PUT/SEttle',()=>{
    ...
    beforeEach(async()=>{
            await User({name:"notifyuser",phoneNumber:"1313131210",fcmToken:"1"}).save()
            await User({name:"notifyuser2",phoneNumber:"1313131212",fcmToken:"2"}).save()
      const khata = await new Khata(khata1).save()
      token = new User({_id:userid,phoneNumber:"1313131212",name:"name1"}).generateAuthToken();
      token2 = new User({_id:userid2,phoneNumber:"1313131210",name:"name2"}).generateAuthToken();
      khataId = khata._id
      khataIds=[khataId]
      payload= {khataIds}
    })
