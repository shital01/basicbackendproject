...
// 		const friendPhoneNumber =
// 			numbers[Math.floor(Math.random() * numbers.length)];
// 		const interestRate = Math.floor(Math.random() * 10); // Random interest rate up to 100
// 		const interestType =
// 			interestTypes[Math.floor(Math.random() * interestTypes.length)]; // Random interest period
// 		const rotationPeriod = ['3M', '6M', '1Y'][
...
// 	const result = await Khata.insertMany(generatedKhataData, {
// 		ordered: false,
// 	});
// 	console.log(result);
// 	return result;
...
// 	const result = await Transaction.insertMany(generatedTransactionData, {
// 		ordered: false,
// 	});
// 	console.log(result);
// }

// router.post('/genKhata', auth, async (req: any, res: any) => {
// 	generatedKhataData = generateRandomKhataData(
// 		req.user.name,
...
// 	res.send(result);
// });
// router.post('/genTransaction', auth, async (req: any, res: any) => {
// 	let Ids = await getKhataIds(req.user._id); //later user based not single user
// 	console.log(Ids);
// 	generatedTransactionData = generateRandomTransactionData(
// 		req.user.name,
// 		req.user.phoneNumber,
// 		req.user._id,
// 		Ids,
...
// 	const nextRotation = moment(transactionDate).add(
...
// router.post('/showcalculations', auth, async (req: any, res: any) => {
// 	try {
...
// 				khataTotal += transaction.amountGiveBool
// 					? -1 * (amount + interest)
// 					: amount + interest;
// 			}
...
// // Assuming you have models defined for User, Khata, and Transaction
// router.post('/showcalculations1', auth, async (req: any, res: any) => {
// 	try {
// 		const khatas = await Khata.find({ userId: req.user._id });
...
// 				const test = calculateRotations1(
// 					transactionDateMoment,
// 					t,
// 					currentDate,
// 				);
...
// // Assuming you have models defined for User, Khata, and Transaction
// //for khata specific
// router.post('/showcalculations3/', auth, async (req: any, res: any) => {
// 	try {
...
// 			return res
// 				.status(404)
// 				.json({ error: 'Khata not found for the user' });
// 		}
...
// router.post('/showcalculations4/', auth, async (req: any, res: any) => {
// 	try {
// 		const khataId = req.body.khataId; // Extract khataId from request parameters
...
// 		amount * Math.pow(1 + r1, totalRotations) * (1 + remainingDays * r2);
// 	return compoundAmount - amount;
// }

// router.post('/removeduplicate', async (req: any, res: any) => {
...
// 						} else {
// 							console.log(
// 								`${result.deletedCount} duplicate documents deleted.`,
// 							);
// 							res.send(
// 								'success' +
// 									`${result.deletedCount} duplicate documents deleted.`,
...
// router.post('/showcalculations2', auth, async (req: any, res: any) => {
// 	//Code here
