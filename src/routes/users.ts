...
import logger from '../startup/logging';const { validateRequest } = require('../middleware/validateRequest');
...
/*
//friendsprofile pic
router.post('/friendsprofile',auth,validateInput(validateNumbers),async(req: any,res: any)=>{
